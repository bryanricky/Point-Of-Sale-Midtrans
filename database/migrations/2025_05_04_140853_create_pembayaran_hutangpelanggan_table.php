...
return new class extends Migration
{
    ...
    {
        Schema::create('pembayaran_hutangpelanggan', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('id_penjualan'); // sesuaikan dengan primary key dari tabel pembelian
    ...
    {
        Schema::dropIfExists('pembayaran_hutangpelanggan');
    }
};
