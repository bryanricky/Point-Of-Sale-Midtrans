    ...
    <div class="wrapper">
        ...
        <div class="info">
            ...
            <div class="item">
                <span>Tanggal</span>
                <span>
                    @if(!empty($pembayaranSekarang) && $pembayaranSekarang->tanggal_pembayaran)
                        {{ \Carbon\Carbon::parse($pembayaranSekarang->tanggal_pembayaran)->format('d/m/Y H:i') }}
                    @else
                        -
                    @endif
                </span>
            ...
            <div class="item">
                <span>Status</span>
                <span class="{{ strtolower($pembelian->status_pembayaran ?? '') == 'lunas' ? 'status-lunas' : 'status-belum' }}">
