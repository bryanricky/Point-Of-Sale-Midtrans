        ...
        <div class="card-body">
            <form id="midtrans-form" style="font-size: 18px;">
                ...
                <div class="d-flex gap-2">
                    <button type="button" id="pay-button" class="btn btn-success flex-grow-1" data-id="{{ $pembelian->id }}">
    ...
    document.getElementById('pay-button').addEventListener('click', function () {
        ...
        snap.pay(snapToken, {
            onSuccess: function (result) {
                ...
                window.location.href = "{{ route('hutang.success', ['id' => $pembelian->id_pembelian]) }}";
            },
