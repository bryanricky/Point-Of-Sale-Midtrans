        ...
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="path_foto" class="col-lg-2 col-lg-offset-1 control-label">Foto KTP</label>
                        <div class="col-lg-6">
                            <input type="file" class="form-control" name="path_foto" onchange="previewFoto(this)">
                            <img id="preview-foto" src="" class="img-thumbnail mt-2" width="100" style="margin-top: 10px;">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
