...
@section('title')
    Daftar Penjualan Kredit ke Pelanggan
@endsection
...
<style>
    ...
    .text-hutang {
        ...
        font-size: 18px; /* Adjust the font size as needed */
        font-weight: normal; /* Optional: Make the text bold */
        padding-left: 8px;  /* Increase the padding */
        padding-right: 8px; /* Increase the padding */
    }
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <a href="{{ route('penjualan_detailkredit.index') }}" class="btn btn-info btn-sm btn-flat"><i class="fa fa-pencil"></i> Transaksi Aktif</a>
                @endempty
            </div>
            <div class="box-body table-responsive">
                <table class="table table-striped table-bordered border-dark table-hover shadow-sm table-penjualankredit">
                    <thead>
                        <tr>
...
@includeIf('penjualankredit.pelanggan')
@includeIf('penjualankredit.detail')
@endsection
...
<script>
    ...
    $(function () {
        table = $('.table-penjualankredit').DataTable({
            ...
            var statusCell = $(row).find('td').eq(9); // Menargetkan sel status pembayaran
